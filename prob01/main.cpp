...
int main()
{
  ...
  std::cout << "\n They are drifting away from the value of 0 and is slowly increasing." << std::endl;
  std::cout << sizeof(d2) << " bytes, value: " << d2 << std::endl;
  std::cout << sizeof(f2) << " bytes, value: " << f2 << std::endl;
  ...
  std::cout << "\n They are approaching closer and closer to the value of 0." << std::endl;
  std::cout << sizeof(d2) << " bytes, value: " << d2 << std::endl;
  std::cout << sizeof(f2) << " bytes, value: " << f2 << std::endl;
  ...
  std::cout << "\n The added setprecision variouable manipulated the program so it would only have one decimal number. Rounding could have happened here too." << std::endl;
